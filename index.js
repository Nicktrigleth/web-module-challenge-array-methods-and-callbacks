...
const yearFilter = fifaData.filter((year) => {
    return year.Year === 2014 && year.Stage === 'Final';
});
console.log(yearFilter);
//(a) Home Team name for 2014 world cup final
console.log('task 1a:', yearFilter[0]['Home Team Name']);
//(b) Away Team name for 2014 world cup final
console.log('task 1b:', yearFilter[0]['Away Team Name']);
//(c) Home Team goals for 2014 world cup final
console.log('task 1c:', yearFilter[0]['Home Team Goals']);
//(d) Away Team goals for 2014 world cup final
console.log('task1d:', yearFilter[0]['Away Team Goals']);
//(e) Winner of 2014 world cup final */
console.log('task1e:', yearFilter[0]['Win conditions']);
...
function getWinners(array, callback) {
    return callback(array).map(item => item['Home Team Goals'] > item['Away Team Goals'] ? item['Home Team Name'] : item['Away Team Name']);
}
